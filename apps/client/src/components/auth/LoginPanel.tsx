    ...
    <main className="auth-page-shell">
      ...
      <motion.section className="auth-entry-panel" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
        ...
        <>
            ...
            <button className="guest-auth-button" onClick={() => continueAsGuest(displayName)}>
              <UserRound size={19} />
            ...
            {loading ? (
              <p className="auth-restore-note"><LoaderCircle className="animate-spin" size={15} /> Restoring your Google profile. Guest play is still available.</p>
            ) : null}
